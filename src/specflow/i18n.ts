...
const EN: Dict = {
  ...
  spec_dashboard: 'Specifications',
  spec_new: 'New Spec',
  spec_new_from_scratch: 'New from Scratch',
  spec_edit: 'Edit Spec',
  spec_name: 'Name',
  spec_content: 'Content',
  spec_input_node: 'Input Node',
  spec_output_nodes: 'Collect Output From',
  spec_add_output: 'Add Output',
  spec_output_label: 'Label',
  spec_status: 'Status',
  spec_actions: 'Actions',
  spec_last_result: 'Last Run Result',
  spec_mark_template: 'Star',
  spec_unmark_template: 'Unstar',
  spec_template_tag: 'Template',
  spec_run: 'Run',
  spec_cancel: 'Cancel',
  spec_edit_btn: 'Edit',
  spec_delete: 'Delete',
  ...
  spec_status_pending: 'Pending',
  spec_status_running: 'Running',
  spec_status_finished: 'Finished',
  spec_status_error: 'Error',
  spec_no_specs: 'No specifications yet. Create one to get started.',
  spec_no_named_nodes: 'No named nodes available. Add custom names to nodes first.',
  spec_node_deleted: 'Node was deleted',
  spec_run_history: 'Run History',
  spec_no_history: 'No runs yet',
  spec_run_at: 'Run at',
  spec_duration: 'Duration',
  spec_outputs: 'Outputs',
  spec_no_outputs: 'No outputs collected',
  spec_select_node: 'Select a node...',
  spec_confirm_delete: 'Delete this specification?',
...
const ZH: Dict = {
  ...
  spec_dashboard: '规格',
  spec_new: '新建规格',
  spec_new_from_scratch: '从空白创建',
  spec_edit: '编辑规格',
  spec_name: '名称',
  spec_content: '内容',
  spec_input_node: '输入节点',
  spec_output_nodes: '输出收集',
  spec_add_output: '添加输出',
  spec_output_label: '标签',
  spec_status: '状态',
  spec_actions: '操作',
  spec_last_result: '最近运行结果',
  spec_mark_template: '标为模板',
  spec_unmark_template: '取消模板',
  spec_template_tag: '模板',
  spec_run: '运行',
  spec_cancel: '取消',
  spec_edit_btn: '编辑',
  spec_delete: '删除',
  spec_history: '历史',
  spec_status_ready: '就绪',
  spec_status_pending: '排队中',
  spec_status_running: '运行中',
  spec_status_finished: '完成',
  spec_status_error: '出错',
  spec_no_specs: '暂无规格，先创建一个。',
  spec_no_named_nodes: '没有可用的已命名节点，请先给节点设置自定义名称。',
  spec_node_deleted: '节点已删除',
  spec_run_history: '运行历史',
  spec_no_history: '暂无运行记录',
  spec_run_at: '运行时间',
  spec_duration: '耗时',
  spec_outputs: '输出',
  spec_no_outputs: '未收集到输出',
  spec_select_node: '选择节点...',
  spec_confirm_delete: '删除这个规格？',
  ...
  canvas_settings_title: '画布设置',
  canvas_name: '画布名称',
  canvas_default_repo_path: '默认仓库路径',
  rename: '重命名',
  duplicate: '复制',
  duplicate_canvas_as: '复制画布为',
  delete_canvas: '删除画布',
  confirm_delete_canvas: '删除此画布文件并关闭标签页？',
